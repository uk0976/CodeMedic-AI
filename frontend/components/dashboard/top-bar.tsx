...
import { Search, Menu, ChevronDown, Cpu, Moon, Sun, Activity, Settings } from "lucide-react";
...
export function TopBar({ onMenuClick, onOpenSettings }: TopBarProps) {
  ...
  const models = ["OpenAI Codex (Default)", "Gemini 3.5 Flash", "Gemini 3.5 Pro"];
        ...
        <div className="relative">
          ...
          {isModelDropdownOpen && (
            <>
              ...
              <div className="absolute right-0 z-20 mt-2 w-56 origin-top-right rounded-xl border border-slate-800 bg-slate-950 p-1.5 shadow-2xl">
                {models.map((m) => (
                  <button
                    key={m}
                    type="button"
